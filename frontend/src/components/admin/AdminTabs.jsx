...
import { 
  Send, Bell, Users, Mail, UtensilsCrossed, 
  Trash2, Eye, Check, X, Plus, Edit2, 
...
// Social Posts Tab - Manage comments/posts across all locations
...
export { LoginForm, DashboardStats, LoyaltyMembersTab, ContactsTab, MenuItemsTab, AdminAccountsTab, NotificationsTab, SpecialsTab, GalleryTab, LocationsTab, VideosTab, SocialTab, EventsTab, GallerySubmissionsTab, SocialPostsTab, UsersTab };