    ...
    <div ref={containerRef} className="flex justify-center">
      <blockquote
        ...
        style={{
          ...
          margin: 1, maxWidth: 540, minWidth: 326, padding: 0, width: '99.375%'
        }}
      >
        <div style={{ padding: 16 }}>
          ...
          <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: 14, lineHeight: '17px', marginBottom: 0, marginTop: 8, overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            <a href="https://www.instagram.com/finandfeathers/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: 14, fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">
              Fin &amp; Feathers Restaurants
            </a> (@<a href="https://www.instagram.com/finandfeathers/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: 14, fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">finandfeathers</a>) &bull; Instagram photos and videos
          </p>
        </div>
      </blockquote>
    </div>
