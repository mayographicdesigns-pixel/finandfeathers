...
const InstagramEmbed = () => {
  ...
  return (
    <div ref={containerRef}>
      <div className="bg-white rounded-lg overflow-hidden" style={{ minHeight: 300, maxHeight: 350 }}>
        <blockquote
          ...
          style={{
            ...
            boxShadow: 'none',
            margin: 0, maxWidth: '100%', minWidth: 0, padding: 0, width: '100%'
          }}
        >
          <div style={{ padding: 12, textAlign: 'center' }}>
            <a
              href="https://www.instagram.com/finandfeathers/"
              style={{ color: '#3897f0', fontFamily: 'Arial,sans-serif', fontSize: 13, fontWeight: 550, textDecoration: 'none' }}
              target="_blank"
      ...
      <Button
        ...
        className="w-full mt-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-xs h-8"
        data-testid="ig-visit-btn"
        size="sm"
      >
...
const FacebookEmbed = () => {
  return (
    <div>
      <div className="bg-white rounded-lg overflow-hidden" style={{ minHeight: 300 }}>
        <iframe
          src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ffinandfeathersrestaurants&tabs=timeline&width=260&height=350&small_header=true&adapt_container_width=true&hide_cover=true&show_facepile=false"
          width="100%"
          height="350"
    ...
    <div className="min-h-screen bg-black py-8 px-4 relative" style={{
      ...
      <div className={`max-w-2xl mx-auto ${isAdmin ? 'pt-12' : ''}`}>
        ...
        <div className="space-y-3 mb-6">
          ...
          {/* Social Media Feed Section — 2-Column */}
          <Card className="bg-slate-800/50 border-slate-700" data-testid="social-feed-section">
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* Facebook Column */}
                <div className="min-w-0 overflow-hidden" data-testid="fb-feed-embed">
                  <FacebookEmbed />
                </div>
                {/* Instagram Column */}
                <div className="min-w-0 overflow-hidden" data-testid="ig-feed-embed">
                  <InstagramEmbed />
                </div>
              </div>
            </CardContent>
